...
class MyItemPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final itemArgs = item;
    return Scaffold(
      appBar: AppBar(backgroundColor: Color.fromARGB(174, 191, 243, 33), title: Text('Item Details')),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 8),
                  Text(
                    'Ini adalah produk ${itemArgs.name}. Minuman "Fruity Cheese Milk" kaya akan sari rasa buah, terdiri dari 3 Varian Rasa yaitu Alpukat, Mangga, dan Strawberry.',
                    style: TextStyle(
                      fontSize: 14,
